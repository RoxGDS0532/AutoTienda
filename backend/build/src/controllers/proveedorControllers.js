...
class ProveedorController {
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            try {
                const result = yield database_1.default.query('UPDATE Proveedores SET Nombre = ?, Contacto = ?, Telefono = ?, Email = ?, CategoriaId = ?, WHERE Id = ?', [Nombre, Contacto, Telefono, Email, Id]);
